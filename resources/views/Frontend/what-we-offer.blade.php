...
Explore The Bookify’s full range of accounting, bookkeeping, payroll, tax, and CFO services designed to support business growth with accuracy, transparency, and expertise. 
@endsection
...
@endsection   {{-- ← FIX: Structured data section properly closed --}}

@section('content')

<style>
/* FIXED: No overflow hidden issues */
html, body {
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp">
                    ...
                    <div class="service-item-content">
                        <h3>Bookkeeping</h3>
                        <p>We at The Bookify intent to provide best-in-class bookkeeping solutions for all types of ventures. Our bookkeeping services ensure timely response as per the needs of our clientele.</p>
                        <a href="/what-we-offer/bookkeeping-services" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="service-item-content">
                        <h3>Payroll</h3>
                        <p>The Bookify have provided the best payroll services in the industry. We are innovative and forward-thinking. We offer many different payroll services to meet your company’s needs.</p>
                        <a href="/what-we-offer/payroll-services" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="service-item-content">
                        ...
                        <p>You may have heard of the term “accountant” and may be wondering what they do. The bookify is a firm that offers tax planning, accounting, bookkeeping, and payroll services.</p>
                        <a href="/what-we-offer/tax-and-accounting" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <div class="service-item-content">
                        ...
                        <a href="/what-we-offer/cfo-advisory" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <div class="service-item-content">
                        <h3>Incorporation</h3>
                        <p>The Bookify have been providing incorporation services for over 10 years. We incorporate a wide range of entities to meet the diverse needs of our clients.</p>
                        <a href="/what-we-offer/incorporation" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item wow fadeInUp" data-wow-delay="1s">
                    ...
                    <div class="service-item-content">
                        ...
                        <p>The Bookify is a group of qualified and experienced experts in the field of taxation who strive to offer the best Sale tax consulting services. We understand that it can be hard to handle all the different rules and regulations in this field on your own, which is why we are here to help.</p>
                        <a href="/what-we-offer/sales-tax-consulting" class="service-btn">
                            <img src="/frontend/images/arrow-white.svg" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
    <div class="service-footer wow fadeInUp text-center" data-wow-delay="1.2s">

        <h5 style="font-size: 24px; font-weight: 600; margin-bottom: 20px;">
