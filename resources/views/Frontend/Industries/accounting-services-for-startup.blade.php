        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="page-header-box text-center">
                    ...
                    <p style="color:#fff; font-size:20px;">Streamline your dream start-up into the core and fly high with our unique blanket of services.</p>
                        ...
                        <div class="faq-accordion" id="faqaccordion">
                            <div class="accordion-item wow fadeInUp">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="heading1" data-bs-parent="#faqaccordion">
                                    <div class="accordion-body">
                                        <p>There is no absolute time to look for professional help other than when you start your startup. It will ensure a kickstart of your venture. However, you may avail our services at any time when you decide to make things easy for you.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                <h2 class="accordion-header" id="heading5">
                                   ...
                                   Is availing of the BOOKIFY service for a start-up cost-efficient ?
                                    </button>
                                </h2>
                                <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#faqaccordion">
                                    <div class="accordion-body">
                                        <p>The Bookify has various plans from which you may choose the suitable one. The plans are themselves cost-efficient in terms of price. Also, availing of the service gives you access to various cost-efficient solutions to your everyday requirements or problems.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item wow fadeInUp">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="heading1" data-bs-parent="#faqaccordion">
                                    <div class="accordion-body">
                                        <p>Marks and devious Semikoli but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
