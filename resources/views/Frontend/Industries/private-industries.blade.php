        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="page-header-box text-center">
                    ...
                    <p style="color:#fff; font-size:20px;">Our private industry-focused CPA services can assist your company in meeting its objectives while minimizing your tax liability.
                    </p>
